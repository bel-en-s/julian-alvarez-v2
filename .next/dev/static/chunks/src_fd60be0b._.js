...
const Menu = ()=>{
    ...
    const webRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])(null);
    const toggleMenu = ()=>{
        if (isOpen) closeMenu();
        else openMenu();
    };
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "Menu.useEffect": ()=>{
            ...
            return ({
                "Menu.useEffect": ()=>window.removeEventListener("resize", fit)
            })["Menu.useEffect"];
        }
    }["Menu.useEffect"], []);
...
_s(Menu, "X/QCWJ39GBkj+IBwe4kAD3JrxCE=");
_c = Menu;
