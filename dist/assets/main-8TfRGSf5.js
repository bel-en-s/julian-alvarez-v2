...
}`,kp=[new z(1,0,0),new z(-1,0,0),new z(0,1,0),new z(0,-1,0),new z(0,0,1),new z(0,0,-1)],Wp=[new z(0,-1,0),new z(0,-1,0),new z(0,0,1),new z(0,0,-1),new z(0,-1,0),new z(0,-1,0)],Go=new _t,Pi=new z,_s=new z;function Xp(i,e,t){let n=new ml;const r=new Ze,s=new Ze,a=new ot,o=new ru,c=new su,l={},h=t.maxTextureSize,g={[In]:Ct,[Ct]:In,[mn]:mn},u=new Ht({defines:{VSM_SAMPLES:8},uniforms:{shadow_pass:{value:null},resolution:{value:new Ze},radius:{value:4}},vertexShader:Vp,fragmentShader:Hp}),f=u.clone();f.defines.HORIZONTAL_PASS=1;const _=new En;_.setAttribute("position",new ln(new Float32Array([-1,-1,.5,3,-1,.5,-1,3,.5]),3));const S=new Kt(_,u),p=this;this.enabled=!1,this.autoUpdate=!0,this.needsUpdate=!1,this.type=_r;let d=this.type;this.render=function(E,R,v){if(p.enabled===!1||p.autoUpdate===!1&&p.needsUpdate===!1||E.length===0)return;this.type===Kl&&(Ie("WebGLShadowMap: PCFSoftShadowMap has been deprecated. Using PCFShadowMap instead."),this.type=_r);const T=i.getRenderTarget(),D=i.getActiveCubeFace(),C=i.getActiveMipmapLevel(),N=i.state;N.setBlending(_n),N.buffers.depth.getReversed()===!0?N.buffers.color.setClear(0,0,0,0):N.buffers.color.setClear(1,1,1,1),N.buffers.depth.setTest(!0),N.setScissorTest(!1);const Z=d!==this.type;Z&&R.traverse(function(K){K.material&&(Array.isArray(K.material)?K.material.forEach(F=>F.needsUpdate=!0):K.material.needsUpdate=!0)});for(let K=0,F=E.length;K<F;K++){const q=E[K],V=q.shadow;if(V===void 0){Ie("WebGLShadowMap:",q,"has no shadow.");continue}if(V.autoUpdate===!1&&V.needsUpdate===!1)continue;r.copy(V.mapSize);const Y=V.getFrameExtents();r.multiply(Y),s.copy(V.mapSize),(r.x>h||r.y>h)&&(r.x>h&&(s.x=Math.floor(h/Y.x),r.x=s.x*Y.x,V.mapSize.x=s.x),r.y>h&&(s.y=Math.floor(h/Y.y),r.y=s.y*Y.y,V.mapSize.y=s.y));const ee=i.state.buffers.depth.getReversed();if(V.camera._reversedDepth=ee,V.map===null||Z===!0){if(V.map!==null&&(V.map.depthTexture!==null&&(V.map.depthTexture.dispose(),V.map.depthTexture=null),V.map.dispose()),this.type===Li){if(q.isPointLight){Ie("WebGLShadowMap: VSM shadow maps are not supported for PointLights. Use PCF or BasicShadowMap instead.");continue}V.map=new Gt(r.x,r.y,{format:qn,type:Mn,minFilter:gt,magFilter:gt,generateMipmaps:!1}),V.map.texture.name=q.name+".shadowMap",V.map.depthTexture=new Mi(r.x,r.y,zt),V.map.depthTexture.name=q.name+".shadowMapDepth",V.map.depthTexture.format=Sn,V.map.depthTexture.compareFunction=null,V.map.depthTexture.minFilter=Et,V.map.depthTexture.magFilter=Et}else q.isPointLight?(V.map=new El(r.x),V.map.depthTexture=new Qc(r.x,cn)):(V.map=new Gt(r.x,r.y),V.map.depthTexture=new Mi(r.x,r.y,cn)),V.map.depthTexture.name=q.name+".shadowMap",V.map.depthTexture.format=Sn,this.type===_r?(V.map.depthTexture.compareFunction=ee?va:_a,V.map.depthTexture.minFilter=gt,V.map.depthTexture.magFilter=gt):(V.map.depthTexture.compareFunction=null,V.map.depthTexture.minFilter=Et,V.map.depthTexture.magFilter=Et);V.camera.updateProjectionMatrix()}const ae=V.map.isWebGLCubeRenderTarget?6:1;for(let se=0;se<ae;se++){if(V.map.isWebGLCubeRenderTarget)i.setRenderTarget(V.map,se),i.clear();else{se===0&&(i.setRenderTarget(V.map),i.clear());const fe=V.getViewport(se);a.set(s.x*fe.x,s.y*fe.y,s.x*fe.z,s.y*fe.w),N.viewport(a)}if(q.isPointLight){const fe=V.camera,ne=V.matrix,ie=q.distance||fe.far;ie!==fe.far&&(fe.far=ie,fe.updateProjectionMatrix()),Pi.setFromMatrixPosition(q.matrixWorld),fe.position.copy(Pi),_s.copy(fe.position),_s.add(kp[se]),fe.up.copy(Wp[se]),fe.lookAt(_s),fe.updateMatrixWorld(),ne.makeTranslation(-Pi.x,-Pi.y,-Pi.z),Go.multiplyMatrices(fe.projectionMatrix,fe.matrixWorldInverse),V._frustum.setFromProjectionMatrix(Go,fe.coordinateSystem,fe.reversedDepth)}else V.updateMatrices(q);n=V.getFrustum(),M(R,v,V.camera,q,this.type)}V.isPointLightShadow!==!0&&this.type===Li&&A(V,v),V.needsUpdate=!1}d=this.type,p.needsUpdate=!1,i.setRenderTarget(T,D,C)};function A(E,R){const v=e.update(S);u.defines.VSM_SAMPLES!==E.blurSamples&&(u.defines.VSM_SAMPLES=E.blurSamples,f.defines.VSM_SAMPLES=E.blurSamples,u.needsUpdate=!0,f.needsUpdate=!0),E.mapPass===null&&(E.mapPass=new Gt(r.x,r.y,{format:qn,type:Mn})),u.uniforms.shadow_pass.value=E.map.depthTexture,u.uniforms.resolution.value=E.mapSize,u.uniforms.radius.value=E.radius,i.setRenderTarget(E.mapPass),i.clear(),i.renderBufferDirect(R,null,v,u,S,null),f.uniforms.shadow_pass.value=E.mapPass.texture,f.uniforms.resolution.value=E.mapSize,f.uniforms.radius.value=E.radius,i.setRenderTarget(E.map),i.clear(),i.renderBufferDirect(R,null,v,f,S,null)}function b(E,R,v,T){let D=null;const C=v.isPointLight===!0?E.customDistanceMaterial:E.customDepthMaterial;if(C!==void 0)D=C;else if(D=v.isPointLight===!0?c:o,i.localClippingEnabled&&R.clipShadows===!0&&Array.isArray(R.clippingPlanes)&&R.clippingPlanes.length!==0||R.displacementMap&&R.displacementScale!==0||R.alphaMap&&R.alphaTest>0||R.map&&R.alphaTest>0||R.alphaToCoverage===!0){const N=D.uuid,Z=R.uuid;let K=l[N];K===void 0&&(K={},l[N]=K);let F=K[Z];F===void 0&&(F=D.clone(),K[Z]=F,R.addEventListener("dispose",w)),D=F}if(D.visible=R.visible,D.wireframe=R.wireframe,T===Li?D.side=R.shadowSide!==null?R.shadowSide:R.side:D.side=R.shadowSide!==null?R.shadowSide:g[R.side],D.alphaMap=R.alphaMap,D.alphaTest=R.alphaToCoverage===!0?.5:R.alphaTest,D.map=R.map,D.clipShadows=R.clipShadows,D.clippingPlanes=R.clippingPlanes,D.clipIntersection=R.clipIntersection,D.displacementMap=R.displacementMap,D.displacementScale=R.displacementScale,D.displacementBias=R.displacementBias,D.wireframeLinewidth=R.wireframeLinewidth,D.linewidth=R.linewidth,v.isPointLight===!0&&D.isMeshDistanceMaterial===!0){const N=i.properties.get(D);N.light=v}return D}function M(E,R,v,T,D){if(E.visible===!1)return;if(E.layers.test(R.layers)&&(E.isMesh||E.isLine||E.isPoints)&&(E.castShadow||E.receiveShadow&&D===Li)&&(!E.frustumCulled||n.intersectsObject(E))){E.modelViewMatrix.multiplyMatrices(v.matrixWorldInverse,E.matrixWorld);const Z=e.update(E),K=E.material;if(Array.isArray(K)){const F=Z.groups;for(let q=0,V=F.length;q<V;q++){const Y=F[q],ee=K[Y.materialIndex];if(ee&&ee.visible){const ae=b(E,ee,T,D);E.onBeforeShadow(i,E,R,v,Z,ae,Y),i.renderBufferDirect(v,null,Z,ae,E,Y),E.onAfterShadow(i,E,R,v,Z,ae,Y)}}}else if(K.visible){const F=b(E,K,T,D);E.onBeforeShadow(i,E,R,v,Z,F,null),i.renderBufferDirect(v,null,Z,F,E,null),E.onAfterShadow(i,E,R,v,Z,F,null)}}const N=E.children;for(let Z=0,K=N.length;Z<K;Z++)M(N[Z],R,v,T,D)}function w(E){E.target.removeEventListener("dispose",w);for(const v in l){const T=l[v],D=E.target.uuid;D in T&&(T[D].dispose(),delete T[D])}}}function qp(i,e){function t(){let P=!1;const ue=new ot;let J=null;const he=new ot(0,0,0,0);return{setMask:function(pe){J!==pe&&!P&&(i.colorMask(pe,pe,pe,pe),J=pe)},setLocked:function(pe){P=pe},setClear:function(pe,te,Pe,Ae,ut){ut===!0&&(pe*=Ae,te*=Ae,Pe*=Ae),ue.set(pe,te,Pe,Ae),he.equals(ue)===!1&&(i.clearColor(pe,te,Pe,Ae),he.copy(ue))},reset:function(){P=!1,J=null,he.set(-1,0,0,0)}}}function n(){let P=!1,ue=!1,J=null,he=null,pe=null;return{setReversed:function(te){if(ue!==te){const Pe=e.get("EXT_clip_control");te?Pe.clipControlEXT(Pe.LOWER_LEFT_EXT,Pe.ZERO_TO_ONE_EXT):Pe.clipControlEXT(Pe.LOWER_LEFT_EXT,Pe.NEGATIVE_ONE_TO_ONE_EXT),ue=te;const Ae=pe;pe=null,this.setClear(Ae)}},getReversed:function(){return ue},setTest:function(te){te?Q(i.DEPTH_TEST):be(i.DEPTH_TEST)},setMask:function(te){J!==te&&!P&&(i.depthMask(te),J=te)},setFunc:function(te){if(ue&&(te=wc[te]),he!==te){switch(te){case Ss:i.depthFunc(i.NEVER);break;case Es:i.depthFunc(i.ALWAYS);break;case ys:i.depthFunc(i.LESS);break;case vi:i.depthFunc(i.LEQUAL);break;case bs:i.depthFunc(i.EQUAL);break;case Ts:i.depthFunc(i.GEQUAL);break;case As:i.depthFunc(i.GREATER);break;case ws:i.depthFunc(i.NOTEQUAL);break;default:i.depthFunc(i.LEQUAL)}he=te}},setLocked:function(te){P=te},setClear:function(te){pe!==te&&(pe=te,ue&&(te=1-te),i.clearDepth(te))},reset:function(){P=!1,J=null,he=null,pe=null,ue=!1}}}function r(){let P=!1,ue=null,J=null,he=null,pe=null,te=null,Pe=null,Ae=null,ut=null;return{setTest:function(rt){P||(rt?Q(i.STENCIL_TEST):be(i.STENCIL_TEST))},setMask:function(rt){ue!==rt&&!P&&(i.stencilMask(rt),ue=rt)},setFunc:function(rt,Zt,$t){(J!==rt||he!==Zt||pe!==$t)&&(i.stencilFunc(rt,Zt,$t),J=rt,he=Zt,pe=$t)},setOp:function(rt,Zt,$t){(te!==rt||Pe!==Zt||Ae!==$t)&&(i.stencilOp(rt,Zt,$t),te=rt,Pe=Zt,Ae=$t)},setLocked:function(rt){P=rt},setClear:function(rt){ut!==rt&&(i.clearStencil(rt),ut=rt)},reset:function(){P=!1,ue=null,J=null,he=null,pe=null,te=null,Pe=null,Ae=null,ut=null}}}const s=new t,a=new n,o=new r,c=new WeakMap,l=new WeakMap;let h={},g={},u={},f=new WeakMap,_=[],S=null,p=!1,d=null,A=null,b=null,M=null,w=null,E=null,R=null,v=new Qe(0,0,0),T=0,D=!1,C=null,N=null,Z=null,K=null,F=null;const q=i.getParameter(i.MAX_COMBINED_TEXTURE_IMAGE_UNITS);let V=!1,Y=0;const ee=i.getParameter(i.VERSION);ee.indexOf("WebGL")!==-1?(Y=parseFloat(/^WebGL (\d)/.exec(ee)[1]),V=Y>=1):ee.indexOf("OpenGL ES")!==-1&&(Y=parseFloat(/^OpenGL ES (\d)/.exec(ee)[1]),V=Y>=2);let ae=null,se={};const fe=i.getParameter(i.SCISSOR_BOX),ne=i.getParameter(i.VIEWPORT),ie=new ot().fromArray(fe),ge=new ot().fromArray(ne);function k(P,ue,J,he){const pe=new Uint8Array(4),te=i.createTexture();i.bindTexture(P,te),i.texParameteri(P,i.TEXTURE_MIN_FILTER,i.NEAREST),i.texParameteri(P,i.TEXTURE_MAG_FILTER,i.NEAREST);for(let Pe=0;Pe<J;Pe++)P===i.TEXTURE_3D||P===i.TEXTURE_2D_ARRAY?i.texImage3D(ue,0,i.RGBA,1,1,he,0,i.RGBA,i.UNSIGNED_BYTE,pe):i.texImage2D(ue+Pe,0,i.RGBA,1,1,0,i.RGBA,i.UNSIGNED_BYTE,pe);return te}const j={};j[i.TEXTURE_2D]=k(i.TEXTURE_2D,i.TEXTURE_2D,1),j[i.TEXTURE_CUBE_MAP]=k(i.TEXTURE_CUBE_MAP,i.TEXTURE_CUBE_MAP_POSITIVE_X,6),j[i.TEXTURE_2D_ARRAY]=k(i.TEXTURE_2D_ARRAY,i.TEXTURE_2D_ARRAY,1,1),j[i.TEXTURE_3D]=k(i.TEXTURE_3D,i.TEXTURE_3D,1,1),s.setClear(0,0,0,1),a.setClear(1),o.setClear(0),Q(i.DEPTH_TEST),a.setFunc(vi),$e(!1),it(Ha),Q(i.CULL_FACE),Be(_n);function Q(P){h[P]!==!0&&(i.enable(P),h[P]=!0)}function be(P){h[P]!==!1&&(i.disable(P),h[P]=!1)}function Me(P,ue){return u[P]!==ue?(i.bindFramebuffer(P,ue),u[P]=ue,P===i.DRAW_FRAMEBUFFER&&(u[i.FRAMEBUFFER]=ue),P===i.FRAMEBUFFER&&(u[i.DRAW_FRAMEBUFFER]=ue),!0):!1}function Se(P,ue){let J=_,he=!1;if(P){J=f.get(ue),J===void 0&&(J=[],f.set(ue,J));const pe=P.textures;if(J.length!==pe.length||J[0]!==i.COLOR_ATTACHMENT0){for(let te=0,Pe=pe.length;te<Pe;te++)J[te]=i.COLOR_ATTACHMENT0+te;J.length=pe.length,he=!0}}else J[0]!==i.BACK&&(J[0]=i.BACK,he=!0);he&&i.drawBuffers(J)}function ke(P){return S!==P?(i.useProgram(P),S=P,!0):!1}const Re={[Vn]:i.FUNC_ADD,[$l]:i.FUNC_SUBTRACT,[Jl]:i.FUNC_REVERSE_SUBTRACT};Re[Ql]=i.MIN,Re[jl]=i.MAX;const Ne={[ec]:i.ZERO,[tc]:i.ONE,[nc]:i.SRC_COLOR,[xs]:i.SRC_ALPHA,[lc]:i.SRC_ALPHA_SATURATE,[ac]:i.DST_COLOR,[rc]:i.DST_ALPHA,[ic]:i.ONE_MINUS_SRC_COLOR,[Ms]:i.ONE_MINUS_SRC_ALPHA,[oc]:i.ONE_MINUS_DST_COLOR,[sc]:i.ONE_MINUS_DST_ALPHA,[cc]:i.CONSTANT_COLOR,[uc]:i.ONE_MINUS_CONSTANT_COLOR,[dc]:i.CONSTANT_ALPHA,[fc]:i.ONE_MINUS_CONSTANT_ALPHA};function Be(P,ue,J,he,pe,te,Pe,Ae,ut,rt){if(P===_n){p===!0&&(be(i.BLEND),p=!1);return}if(p===!1&&(Q(i.BLEND),p=!0),P!==Zl){if(P!==d||rt!==D){if((A!==Vn||w!==Vn)&&(i.blendEquation(i.FUNC_ADD),A=Vn,w=Vn),rt)switch(P){case mi:i.blendFuncSeparate(i.ONE,i.ONE_MINUS_SRC_ALPHA,i.ONE,i.ONE_MINUS_SRC_ALPHA);break;case ka:i.blendFunc(i.ONE,i.ONE);break;case Wa:i.blendFuncSeparate(i.ZERO,i.ONE_MINUS_SRC_COLOR,i.ZERO,i.ONE);break;case Xa:i.blendFuncSeparate(i.DST_COLOR,i.ONE_MINUS_SRC_ALPHA,i.ZERO,i.ONE);break;default:Ke("WebGLState: Invalid blending: ",P);break}else switch(P){case mi:i.blendFuncSeparate(i.SRC_ALPHA,i.ONE_MINUS_SRC_ALPHA,i.ONE,i.ONE_MINUS_SRC_ALPHA);break;case ka:i.blendFuncSeparate(i.SRC_ALPHA,i.ONE,i.ONE,i.ONE);break;case Wa:Ke("WebGLState: SubtractiveBlending requires material.premultipliedAlpha = true");break;case Xa:Ke("WebGLState: MultiplyBlending requires material.premultipliedAlpha = true");break;default:Ke("WebGLState: Invalid blending: ",P);break}b=null,M=null,E=null,R=null,v.set(0,0,0),T=0,d=P,D=rt}return}pe=pe||ue,te=te||J,Pe=Pe||he,(ue!==A||pe!==w)&&(i.blendEquationSeparate(Re[ue],Re[pe]),A=ue,w=pe),(J!==b||he!==M||te!==E||Pe!==R)&&(i.blendFuncSeparate(Ne[J],Ne[he],Ne[te],Ne[Pe]),b=J,M=he,E=te,R=Pe),(Ae.equals(v)===!1||ut!==T)&&(i.blendColor(Ae.r,Ae.g,Ae.b,ut),v.copy(Ae),T=ut),d=P,D=!1}function Ge(P,ue){P.side===mn?be(i.CULL_FACE):Q(i.CULL_FACE);let J=P.side===Ct;ue&&(J=!J),$e(J),P.blending===mi&&P.transparent===!1?Be(_n):Be(P.blending,P.blendEquation,P.blendSrc,P.blendDst,P.blendEquationAlpha,P.blendSrcAlpha,P.blendDstAlpha,P.blendColor,P.blendAlpha,P.premultipliedAlpha),a.setFunc(P.depthFunc),a.setTest(P.depthTest),a.setMask(P.depthWrite),s.setMask(P.colorWrite);const he=P.stencilWrite;o.setTest(he),he&&(o.setMask(P.stencilWriteMask),o.setFunc(P.stencilFunc,P.stencilRef,P.stencilFuncMask),o.setOp(P.stencilFail,P.stencilZFail,P.stencilZPass)),ct(P.polygonOffset,P.polygonOffsetFactor,P.polygonOffsetUnits),P.alphaToCoverage===!0?Q(i.SAMPLE_ALPHA_TO_COVERAGE):be(i.SAMPLE_ALPHA_TO_COVERAGE)}function $e(P){C!==P&&(P?i.frontFace(i.CW):i.frontFace(i.CCW),C=P)}function it(P){P!==ql?(Q(i.CULL_FACE),P!==N&&(P===Ha?i.cullFace(i.BACK):P===Yl?i.cullFace(i.FRONT):i.cullFace(i.FRONT_AND_BACK))):be(i.CULL_FACE),N=P}function lt(P){P!==Z&&(V&&i.lineWidth(P),Z=P)}function ct(P,ue,J){P?(Q(i.POLYGON_OFFSET_FILL),(K!==ue||F!==J)&&(K=ue,F=J,a.getReversed()&&(ue=-ue),i.polygonOffset(ue,J))):be(i.POLYGON_OFFSET_FILL)}function Je(P){P?Q(i.SCISSOR_TEST):be(i.SCISSOR_TEST)}function at(P){P===void 0&&(P=i.TEXTURE0+q-1),ae!==P&&(i.activeTexture(P),ae=P)}function L(P,ue,J){J===void 0&&(ae===null?J=i.TEXTURE0+q-1:J=ae);let he=se[J];he===void 0&&(he={type:void 0,texture:void 0},se[J]=he),(he.type!==P||he.texture!==ue)&&(ae!==J&&(i.activeTexture(J),ae=J),i.bindTexture(P,ue||j[P]),he.type=P,he.texture=ue)}function ft(){const P=se[ae];P!==void 0&&P.type!==void 0&&(i.bindTexture(P.type,null),P.type=void 0,P.texture=void 0)}function We(){try{i.compressedTexImage2D(...arguments)}catch(P){Ke("WebGLState:",P)}}function y(){try{i.compressedTexImage3D(...arguments)}catch(P){Ke("WebGLState:",P)}}function m(){try{i.texSubImage2D(...arguments)}catch(P){Ke("WebGLState:",P)}}function I(){try{i.texSubImage3D(...arguments)}catch(P){Ke("WebGLState:",P)}}function G(){try{i.compressedTexSubImage2D(...arguments)}catch(P){Ke("WebGLState:",P)}}function W(){try{i.compressedTexSubImage3D(...arguments)}catch(P){Ke("WebGLState:",P)}}function oe(){try{i.texStorage2D(...arguments)}catch(P){Ke("WebGLState:",P)}}function de(){try{i.texStorage3D(...arguments)}catch(P){Ke("WebGLState:",P)}}function X(){try{i.texImage2D(...arguments)}catch(P){Ke("WebGLState:",P)}}function $(){try{i.texImage3D(...arguments)}catch(P){Ke("WebGLState:",P)}}function re(P){return g[P]!==void 0?g[P]:i.getParameter(P)}function Te(P,ue){g[P]!==ue&&(i.pixelStorei(P,ue),g[P]=ue)}function le(P){ie.equals(P)===!1&&(i.scissor(P.x,P.y,P.z,P.w),ie.copy(P))}function ce(P){ge.equals(P)===!1&&(i.viewport(P.x,P.y,P.z,P.w),ge.copy(P))}function Ce(P,ue){let J=l.get(ue);J===void 0&&(J=new WeakMap,l.set(ue,J));let he=J.get(P);he===void 0&&(he=i.getUniformBlockIndex(ue,P.name),J.set(P,he))}function Ue(P,ue){const he=l.get(ue).get(P);c.get(ue)!==he&&(i.uniformBlockBinding(ue,he,P.__bindingPointIndex),c.set(ue,he))}function Fe(){i.disable(i.BLEND),i.disable(i.CULL_FACE),i.disable(i.DEPTH_TEST),i.disable(i.POLYGON_OFFSET_FILL),i.disable(i.SCISSOR_TEST),i.disable(i.STENCIL_TEST),i.disable(i.SAMPLE_ALPHA_TO_COVERAGE),i.blendEquation(i.FUNC_ADD),i.blendFunc(i.ONE,i.ZERO),i.blendFuncSeparate(i.ONE,i.ZERO,i.ONE,i.ZERO),i.blendColor(0,0,0,0),i.colorMask(!0,!0,!0,!0),i.clearColor(0,0,0,0),i.depthMask(!0),i.depthFunc(i.LESS),a.setReversed(!1),i.clearDepth(1),i.stencilMask(4294967295),i.stencilFunc(i.ALWAYS,0,4294967295),i.stencilOp(i.KEEP,i.KEEP,i.KEEP),i.clearStencil(0),i.cullFace(i.BACK),i.frontFace(i.CCW),i.polygonOffset(0,0),i.activeTexture(i.TEXTURE0),i.bindFramebuffer(i.FRAMEBUFFER,null),i.bindFramebuffer(i.DRAW_FRAMEBUFFER,null),i.bindFramebuffer(i.READ_FRAMEBUFFER,null),i.useProgram(null),i.lineWidth(1),i.scissor(0,0,i.canvas.width,i.canvas.height),i.viewport(0,0,i.canvas.width,i.canvas.height),i.pixelStorei(i.PACK_ALIGNMENT,4),i.pixelStorei(i.UNPACK_ALIGNMENT,4),i.pixelStorei(i.UNPACK_FLIP_Y_WEBGL,!1),i.pixelStorei(i.UNPACK_PREMULTIPLY_ALPHA_WEBGL,!1),i.pixelStorei(i.UNPACK_COLORSPACE_CONVERSION_WEBGL,i.BROWSER_DEFAULT_WEBGL),i.pixelStorei(i.PACK_ROW_LENGTH,0),i.pixelStorei(i.PACK_SKIP_PIXELS,0),i.pixelStorei(i.PACK_SKIP_ROWS,0),i.pixelStorei(i.UNPACK_ROW_LENGTH,0),i.pixelStorei(i.UNPACK_IMAGE_HEIGHT,0),i.pixelStorei(i.UNPACK_SKIP_PIXELS,0),i.pixelStorei(i.UNPACK_SKIP_ROWS,0),i.pixelStorei(i.UNPACK_SKIP_IMAGES,0),h={},g={},ae=null,se={},u={},f=new WeakMap,_=[],S=null,p=!1,d=null,A=null,b=null,M=null,w=null,E=null,R=null,v=new Qe(0,0,0),T=0,D=!1,C=null,N=null,Z=null,K=null,F=null,ie.set(0,0,i.canvas.width,i.canvas.height),ge.set(0,0,i.canvas.width,i.canvas.height),s.reset(),a.reset(),o.reset()}return{buffers:{color:s,depth:a,stencil:o},enable:Q,disable:be,bindFramebuffer:Me,drawBuffers:Se,useProgram:ke,setBlending:Be,setMaterial:Ge,setFlipSided:$e,setCullFace:it,setLineWidth:lt,setPolygonOffset:ct,setScissorTest:Je,activeTexture:at,bindTexture:L,unbindTexture:ft,compressedTexImage2D:We,compressedTexImage3D:y,texImage2D:X,texImage3D:$,pixelStorei:Te,getParameter:re,updateUBOMapping:Ce,uniformBlockBinding:Ue,texStorage2D:oe,texStorage3D:de,texSubImage2D:m,texSubImage3D:I,compressedTexSubImage2D:G,compressedTexSubImage3D:W,scissor:le,viewport:ce,reset:Fe}}function Yp(i,e,t,n,r,s,a){const o=e.has("WEBGL_multisampled_render_to_texture")?e.get("WEBGL_multisampled_render_to_texture"):null,c=typeof navigator>"u"?!1:/OculusBrowser/g.test(navigator.userAgent),l=new Ze,h=new WeakMap,g=new Set;let u;const f=new WeakMap;let _=!1;try{_=typeof OffscreenCanvas<"u"&&new OffscreenCanvas(1,1).getContext("2d")!==null}catch{}function S(y,m){return _?new OffscreenCanvas(y,m):Pr("canvas")}function p(y,m,I){let G=1;const W=We(y);if((W.width>I||W.height>I)&&(G=I/Math.max(W.width,W.height)),G<1)if(typeof HTMLImageElement<"u"&&y instanceof HTMLImageElement||typeof HTMLCanvasElement<"u"&&y instanceof HTMLCanvasElement||typeof ImageBitmap<"u"&&y instanceof ImageBitmap||typeof VideoFrame<"u"&&y instanceof VideoFrame){const oe=Math.floor(G*W.width),de=Math.floor(G*W.height);u===void 0&&(u=S(oe,de));const X=m?S(oe,de):u;return X.width=oe,X.height=de,X.getContext("2d").drawImage(y,0,0,oe,de),Ie("WebGLRenderer: Texture has been resized from ("+W.width+"x"+W.height+") to ("+oe+"x"+de+")."),X}else return"data"in y&&Ie("WebGLRenderer: Image in DataTexture is too big ("+W.width+"x"+W.height+")."),y;return y}function d(y){return y.generateMipmaps}function A(y){i.generateMipmap(y)}function b(y){return y.isWebGLCubeRenderTarget?i.TEXTURE_CUBE_MAP:y.isWebGL3DRenderTarget?i.TEXTURE_3D:y.isWebGLArrayRenderTarget||y.isCompressedArrayTexture?i.TEXTURE_2D_ARRAY:i.TEXTURE_2D}function M(y,m,I,G,W,oe=!1){if(y!==null){if(i[y]!==void 0)return i[y];Ie("WebGLRenderer: Attempt to use non-existing WebGL internal format '"+y+"'")}let de;G&&(de=e.get("EXT_texture_norm16"),de||Ie("WebGLRenderer: Unable to use normalized textures without EXT_texture_norm16 extension"));let X=m;if(m===i.RED&&(I===i.FLOAT&&(X=i.R32F),I===i.HALF_FLOAT&&(X=i.R16F),I===i.UNSIGNED_BYTE&&(X=i.R8),I===i.UNSIGNED_SHORT&&de&&(X=de.R16_EXT),I===i.SHORT&&de&&(X=de.R16_SNORM_EXT)),m===i.RED_INTEGER&&(I===i.UNSIGNED_BYTE&&(X=i.R8UI),I===i.UNSIGNED_SHORT&&(X=i.R16UI),I===i.UNSIGNED_INT&&(X=i.R32UI),I===i.BYTE&&(X=i.R8I),I===i.SHORT&&(X=i.R16I),I===i.INT&&(X=i.R32I)),m===i.RG&&(I===i.FLOAT&&(X=i.RG32F),I===i.HALF_FLOAT&&(X=i.RG16F),I===i.UNSIGNED_BYTE&&(X=i.RG8),I===i.UNSIGNED_SHORT&&de&&(X=de.RG16_EXT),I===i.SHORT&&de&&(X=de.RG16_SNORM_EXT)),m===i.RG_INTEGER&&(I===i.UNSIGNED_BYTE&&(X=i.RG8UI),I===i.UNSIGNED_SHORT&&(X=i.RG16UI),I===i.UNSIGNED_INT&&(X=i.RG32UI),I===i.BYTE&&(X=i.RG8I),I===i.SHORT&&(X=i.RG16I),I===i.INT&&(X=i.RG32I)),m===i.RGB_INTEGER&&(I===i.UNSIGNED_BYTE&&(X=i.RGB8UI),I===i.UNSIGNED_SHORT&&(X=i.RGB16UI),I===i.UNSIGNED_INT&&(X=i.RGB32UI),I===i.BYTE&&(X=i.RGB8I),I===i.SHORT&&(X=i.RGB16I),I===i.INT&&(X=i.RGB32I)),m===i.RGBA_INTEGER&&(I===i.UNSIGNED_BYTE&&(X=i.RGBA8UI),I===i.UNSIGNED_SHORT&&(X=i.RGBA16UI),I===i.UNSIGNED_INT&&(X=i.RGBA32UI),I===i.BYTE&&(X=i.RGBA8I),I===i.SHORT&&(X=i.RGBA16I),I===i.INT&&(X=i.RGBA32I)),m===i.RGB&&(I===i.UNSIGNED_SHORT&&de&&(X=de.RGB16_EXT),I===i.SHORT&&de&&(X=de.RGB16_SNORM_EXT),I===i.UNSIGNED_INT_5_9_9_9_REV&&(X=i.RGB9_E5),I===i.UNSIGNED_INT_10F_11F_11F_REV&&(X=i.R11F_G11F_B10F)),m===i.RGBA){const $=oe?Rr:Xe.getTransfer(W);I===i.FLOAT&&(X=i.RGBA32F),I===i.HALF_FLOAT&&(X=i.RGBA16F),I===i.UNSIGNED_BYTE&&(X=$===je?i.SRGB8_ALPHA8:i.RGBA8),I===i.UNSIGNED_SHORT&&de&&(X=de.RGBA16_EXT),I===i.SHORT&&de&&(X=de.RGBA16_SNORM_EXT),I===i.UNSIGNED_SHORT_4_4_4_4&&(X=i.RGBA4),I===i.UNSIGNED_SHORT_5_5_5_1&&(X=i.RGB5_A1)}return(X===i.R16F||X===i.R32F||X===i.RG16F||X===i.RG32F||X===i.RGBA16F||X===i.RGBA32F)&&e.get("EXT_color_buffer_float"),X}function w(y,m){let I;return y?m===null||m===cn||m===Ni?I=i.DEPTH24_STENCIL8:m===zt?I=i.DEPTH32F_STENCIL8:m===Ii&&(I=i.DEPTH24_STENCIL8,Ie("DepthTexture: 16 bit depth attachment is not supported with stencil. Using 24-bit attachment.")):m===null||m===cn||m===Ni?I=i.DEPTH_COMPONENT24:m===zt?I=i.DEPTH_COMPONENT32F:m===Ii&&(I=i.DEPTH_COMPONENT16),I}function E(y,m){return d(y)===!0||y.isFramebufferTexture&&y.minFilter!==Et&&y.minFilter!==gt?Math.log2(Math.max(m.width,m.height))+1:y.mipmaps!==void 0&&y.mipmaps.length>0?y.mipmaps.length:y.isCompressedTexture&&Array.isArray(y.image)?m.mipmaps.length:1}function R(y){const m=y.target;m.removeEventListener("dispose",R),T(m),m.isVideoTexture&&h.delete(m),m.isHTMLTexture&&g.delete(m)}function v(y){const m=y.target;m.removeEventListener("dispose",v),C(m)}function T(y){const m=n.get(y);if(m.__webglInit===void 0)return;const I=y.source,G=f.get(I);if(G){const W=G[m.__cacheKey];W.usedTimes--,W.usedTimes===0&&D(y),Object.keys(G).length===0&&f.delete(I)}n.remove(y)}function D(y){const m=n.get(y);i.deleteTexture(m.__webglTexture);const I=y.source,G=f.get(I);delete G[m.__cacheKey],a.memory.textures--}function C(y){const m=n.get(y);if(y.depthTexture&&(y.depthTexture.dispose(),n.remove(y.depthTexture)),y.isWebGLCubeRenderTarget)for(let G=0;G<6;G++){if(Array.isArray(m.__webglFramebuffer[G]))for(let W=0;W<m.__webglFramebuffer[G].length;W++)i.deleteFramebuffer(m.__webglFramebuffer[G][W]);else i.deleteFramebuffer(m.__webglFramebuffer[G]);m.__webglDepthbuffer&&i.deleteRenderbuffer(m.__webglDepthbuffer[G])}else{if(Array.isArray(m.__webglFramebuffer))for(let G=0;G<m.__webglFramebuffer.length;G++)i.deleteFramebuffer(m.__webglFramebuffer[G]);else i.deleteFramebuffer(m.__webglFramebuffer);if(m.__webglDepthbuffer&&i.deleteRenderbuffer(m.__webglDepthbuffer),m.__webglMultisampledFramebuffer&&i.deleteFramebuffer(m.__webglMultisampledFramebuffer),m.__webglColorRenderbuffer)for(let G=0;G<m.__webglColorRenderbuffer.length;G++)m.__webglColorRenderbuffer[G]&&i.deleteRenderbuffer(m.__webglColorRenderbuffer[G]);m.__webglDepthRenderbuffer&&i.deleteRenderbuffer(m.__webglDepthRenderbuffer)}const I=y.textures;for(let G=0,W=I.length;G<W;G++){const oe=n.get(I[G]);oe.__webglTexture&&(i.deleteTexture(oe.__webglTexture),a.memory.textures--),n.remove(I[G])}n.remove(y)}let N=0;function Z(){N=0}function K(){return N}function F(y){N=y}function q(){const y=N;return y>=r.maxTextures&&Ie("WebGLTextures: Trying to use "+y+" texture units while this GPU supports only "+r.maxTextures),N+=1,y}function V(y){const m=[];return m.push(y.wrapS),m.push(y.wrapT),m.push(y.wrapR||0),m.push(y.magFilter),m.push(y.minFilter),m.push(y.anisotropy),m.push(y.internalFormat),m.push(y.format),m.push(y.type),m.push(y.generateMipmaps),m.push(y.premultiplyAlpha),m.push(y.flipY),m.push(y.unpackAlignment),m.push(y.colorSpace),m.join()}function Y(y,m){const I=n.get(y);if(y.isVideoTexture&&L(y),y.isRenderTargetTexture===!1&&y.isExternalTexture!==!0&&y.version>0&&I.__version!==y.version){const G=y.image;if(G===null)Ie("WebGLRenderer: Texture marked for update but no image data found.");else if(G.complete===!1)Ie("WebGLRenderer: Texture marked for update but image is incomplete");else{be(I,y,m);return}}else y.isExternalTexture&&(I.__webglTexture=y.sourceTexture?y.sourceTexture:null);t.bindTexture(i.TEXTURE_2D,I.__webglTexture,i.TEXTURE0+m)}function ee(y,m){const I=n.get(y);if(y.isRenderTargetTexture===!1&&y.version>0&&I.__version!==y.version){be(I,y,m);return}else y.isExternalTexture&&(I.__webglTexture=y.sourceTexture?y.sourceTexture:null);t.bindTexture(i.TEXTURE_2D_ARRAY,I.__webglTexture,i.TEXTURE0+m)}function ae(y,m){const I=n.get(y);if(y.isRenderTargetTexture===!1&&y.version>0&&I.__version!==y.version){be(I,y,m);return}t.bindTexture(i.TEXTURE_3D,I.__webglTexture,i.TEXTURE0+m)}function se(y,m){const I=n.get(y);if(y.isCubeDepthTexture!==!0&&y.version>0&&I.__version!==y.version){Me(I,y,m);return}t.bindTexture(i.TEXTURE_CUBE_MAP,I.__webglTexture,i.TEXTURE0+m)}const fe={[Rs]:i.REPEAT,[gn]:i.CLAMP_TO_EDGE,[Cs]:i.MIRRORED_REPEAT},ne={[Et]:i.NEAREST,[mc]:i.NEAREST_MIPMAP_NEAREST,[Wi]:i.NEAREST_MIPMAP_LINEAR,[gt]:i.LINEAR,[Vr]:i.LINEAR_MIPMAP_NEAREST,[kn]:i.LINEAR_MIPMAP_LINEAR},ie={[vc]:i.NEVER,[yc]:i.ALWAYS,[xc]:i.LESS,[_a]:i.LEQUAL,[Mc]:i.EQUAL,[va]:i.GEQUAL,[Sc]:i.GREATER,[Ec]:i.NOTEQUAL};function ge(y,m){if(m.type===zt&&e.has("OES_texture_float_linear")===!1&&(m.magFilter===gt||m.magFilter===Vr||m.magFilter===Wi||m.magFilter===kn||m.minFilter===gt||m.minFilter===Vr||m.minFilter===Wi||m.minFilter===kn)&&Ie("WebGLRenderer: Unable to use linear filtering with floating point textures. OES_texture_float_linear not supported on this device."),i.texParameteri(y,i.TEXTURE_WRAP_S,fe[m.wrapS]),i.texParameteri(y,i.TEXTURE_WRAP_T,fe[m.wrapT]),(y===i.TEXTURE_3D||y===i.TEXTURE_2D_ARRAY)&&i.texParameteri(y,i.TEXTURE_WRAP_R,fe[m.wrapR]),i.texParameteri(y,i.TEXTURE_MAG_FILTER,ne[m.magFilter]),i.texParameteri(y,i.TEXTURE_MIN_FILTER,ne[m.minFilter]),m.compareFunction&&(i.texParameteri(y,i.TEXTURE_COMPARE_MODE,i.COMPARE_REF_TO_TEXTURE),i.texParameteri(y,i.TEXTURE_COMPARE_FUNC,ie[m.compareFunction])),e.has("EXT_texture_filter_anisotropic")===!0){if(m.magFilter===Et||m.minFilter!==Wi&&m.minFilter!==kn||m.type===zt&&e.has("OES_texture_float_linear")===!1)return;if(m.anisotropy>1||n.get(m).__currentAnisotropy){const I=e.get("EXT_texture_filter_anisotropic");i.texParameterf(y,I.TEXTURE_MAX_ANISOTROPY_EXT,Math.min(m.anisotropy,r.getMaxAnisotropy())),n.get(m).__currentAnisotropy=m.anisotropy}}}function k(y,m){let I=!1;y.__webglInit===void 0&&(y.__webglInit=!0,m.addEventListener("dispose",R));const G=m.source;let W=f.get(G);W===void 0&&(W={},f.set(G,W));const oe=V(m);if(oe!==y.__cacheKey){W[oe]===void 0&&(W[oe]={texture:i.createTexture(),usedTimes:0},a.memory.textures++,I=!0),W[oe].usedTimes++;const de=W[y.__cacheKey];de!==void 0&&(W[y.__cacheKey].usedTimes--,de.usedTimes===0&&D(m)),y.__cacheKey=oe,y.__webglTexture=W[oe].texture}return I}function j(y,m,I){return Math.floor(Math.floor(y/I)/m)}function Q(y,m,I,G){const oe=y.updateRanges;if(oe.length===0)t.texSubImage2D(i.TEXTURE_2D,0,0,0,m.width,m.height,I,G,m.data);else{oe.sort((Te,le)=>Te.start-le.start);let de=0;for(let Te=1;Te<oe.length;Te++){const le=oe[de],ce=oe[Te],Ce=le.start+le.count,Ue=j(ce.start,m.width,4),Fe=j(le.start,m.width,4);ce.start<=Ce+1&&Ue===Fe&&j(ce.start+ce.count-1,m.width,4)===Ue?le.count=Math.max(le.count,ce.start+ce.count-le.start):(++de,oe[de]=ce)}oe.length=de+1;const X=t.getParameter(i.UNPACK_ROW_LENGTH),$=t.getParameter(i.UNPACK_SKIP_PIXELS),re=t.getParameter(i.UNPACK_SKIP_ROWS);t.pixelStorei(i.UNPACK_ROW_LENGTH,m.width);for(let Te=0,le=oe.length;Te<le;Te++){const ce=oe[Te],Ce=Math.floor(ce.start/4),Ue=Math.ceil(ce.count/4),Fe=Ce%m.width,P=Math.floor(Ce/m.width),ue=Ue,J=1;t.pixelStorei(i.UNPACK_SKIP_PIXELS,Fe),t.pixelStorei(i.UNPACK_SKIP_ROWS,P),t.texSubImage2D(i.TEXTURE_2D,0,Fe,P,ue,J,I,G,m.data)}y.clearUpdateRanges(),t.pixelStorei(i.UNPACK_ROW_LENGTH,X),t.pixelStorei(i.UNPACK_SKIP_PIXELS,$),t.pixelStorei(i.UNPACK_SKIP_ROWS,re)}}function be(y,m,I){let G=i.TEXTURE_2D;(m.isDataArrayTexture||m.isCompressedArrayTexture)&&(G=i.TEXTURE_2D_ARRAY),m.isData3DTexture&&(G=i.TEXTURE_3D);const W=k(y,m),oe=m.source;t.bindTexture(G,y.__webglTexture,i.TEXTURE0+I);const de=n.get(oe);if(oe.version!==de.__version||W===!0){if(t.activeTexture(i.TEXTURE0+I),(typeof ImageBitmap<"u"&&m.image instanceof ImageBitmap)===!1){const J=Xe.getPrimaries(Xe.workingColorSpace),he=m.colorSpace===Dn?null:Xe.getPrimaries(m.colorSpace),pe=m.colorSpace===Dn||J===he?i.NONE:i.BROWSER_DEFAULT_WEBGL;t.pixelStorei(i.UNPACK_FLIP_Y_WEBGL,m.flipY),t.pixelStorei(i.UNPACK_PREMULTIPLY_ALPHA_WEBGL,m.premultiplyAlpha),t.pixelStorei(i.UNPACK_COLORSPACE_CONVERSION_WEBGL,pe)}t.pixelStorei(i.UNPACK_ALIGNMENT,m.unpackAlignment);let $=p(m.image,!1,r.maxTextureSize);$=ft(m,$);const re=s.convert(m.format,m.colorSpace),Te=s.convert(m.type);let le=M(m.internalFormat,re,Te,m.normalized,m.colorSpace,m.isVideoTexture);ge(G,m);let ce;const Ce=m.mipmaps,Ue=m.isVideoTexture!==!0,Fe=de.__version===void 0||W===!0,P=oe.dataReady,ue=E(m,$);if(m.isDepthTexture)le=w(m.format===Wn,m.type),Fe&&(Ue?t.texStorage2D(i.TEXTURE_2D,1,le,$.width,$.height):t.texImage2D(i.TEXTURE_2D,0,le,$.width,$.height,0,re,Te,null));else if(m.isDataTexture)if(Ce.length>0){Ue&&Fe&&t.texStorage2D(i.TEXTURE_2D,ue,le,Ce[0].width,Ce[0].height);for(let J=0,he=Ce.length;J<he;J++)ce=Ce[J],Ue?P&&t.texSubImage2D(i.TEXTURE_2D,J,0,0,ce.width,ce.height,re,Te,ce.data):t.texImage2D(i.TEXTURE_2D,J,le,ce.width,ce.height,0,re,Te,ce.data);m.generateMipmaps=!1}else Ue?(Fe&&t.texStorage2D(i.TEXTURE_2D,ue,le,$.width,$.height),P&&Q(m,$,re,Te)):t.texImage2D(i.TEXTURE_2D,0,le,$.width,$.height,0,re,Te,$.data);else if(m.isCompressedTexture)if(m.isCompressedArrayTexture){Ue&&Fe&&t.texStorage3D(i.TEXTURE_2D_ARRAY,ue,le,Ce[0].width,Ce[0].height,$.depth);for(let J=0,he=Ce.length;J<he;J++)if(ce=Ce[J],m.format!==It)if(re!==null)if(Ue){if(P)if(m.layerUpdates.size>0){const pe=_o(ce.width,ce.height,m.format,m.type);for(const te of m.layerUpdates){const Pe=ce.data.subarray(te*pe/ce.data.BYTES_PER_ELEMENT,(te+1)*pe/ce.data.BYTES_PER_ELEMENT);t.compressedTexSubImage3D(i.TEXTURE_2D_ARRAY,J,0,0,te,ce.width,ce.height,1,re,Pe)}m.clearLayerUpdates()}else t.compressedTexSubImage3D(i.TEXTURE_2D_ARRAY,J,0,0,0,ce.width,ce.height,$.depth,re,ce.data)}else t.compressedTexImage3D(i.TEXTURE_2D_ARRAY,J,le,ce.width,ce.height,$.depth,0,ce.data,0,0);else Ie("WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()");else Ue?P&&t.texSubImage3D(i.TEXTURE_2D_ARRAY,J,0,0,0,ce.width,ce.height,$.depth,re,Te,ce.data):t.texImage3D(i.TEXTURE_2D_ARRAY,J,le,ce.width,ce.height,$.depth,0,re,Te,ce.data)}else{Ue&&Fe&&t.texStorage2D(i.TEXTURE_2D,ue,le,Ce[0].width,Ce[0].height);for(let J=0,he=Ce.length;J<he;J++)ce=Ce[J],m.format!==It?re!==null?Ue?P&&t.compressedTexSubImage2D(i.TEXTURE_2D,J,0,0,ce.width,ce.height,re,ce.data):t.compressedTexImage2D(i.TEXTURE_2D,J,le,ce.width,ce.height,0,ce.data):Ie("WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()"):Ue?P&&t.texSubImage2D(i.TEXTURE_2D,J,0,0,ce.width,ce.height,re,Te,ce.data):t.texImage2D(i.TEXTURE_2D,J,le,ce.width,ce.height,0,re,Te,ce.data)}else if(m.isDataArrayTexture)if(Ue){if(Fe&&t.texStorage3D(i.TEXTURE_2D_ARRAY,ue,le,$.width,$.height,$.depth),P)if(m.layerUpdates.size>0){const J=_o($.width,$.height,m.format,m.type);for(const he of m.layerUpdates){const pe=$.data.subarray(he*J/$.data.BYTES_PER_ELEMENT,(he+1)*J/$.data.BYTES_PER_ELEMENT);t.texSubImage3D(i.TEXTURE_2D_ARRAY,0,0,0,he,$.width,$.height,1,re,Te,pe)}m.clearLayerUpdates()}else t.texSubImage3D(i.TEXTURE_2D_ARRAY,0,0,0,0,$.width,$.height,$.depth,re,Te,$.data)}else t.texImage3D(i.TEXTURE_2D_ARRAY,0,le,$.width,$.height,$.depth,0,re,Te,$.data);else if(m.isData3DTexture)Ue?(Fe&&t.texStorage3D(i.TEXTURE_3D,ue,le,$.width,$.height,$.depth),P&&t.texSubImage3D(i.TEXTURE_3D,0,0,0,0,$.width,$.height,$.depth,re,Te,$.data)):t.texImage3D(i.TEXTURE_3D,0,le,$.width,$.height,$.depth,0,re,Te,$.data);else if(m.isFramebufferTexture){if(Fe)if(Ue)t.texStorage2D(i.TEXTURE_2D,ue,le,$.width,$.height);else{let J=$.width,he=$.height;for(let pe=0;pe<ue;pe++)t.texImage2D(i.TEXTURE_2D,pe,le,J,he,0,re,Te,null),J>>=1,he>>=1}}else if(m.isHTMLTexture){if("texElementImage2D"in i){const J=i.canvas;if(J.hasAttribute("layoutsubtree")||J.setAttribute("layoutsubtree","true"),$.parentNode!==J){J.appendChild($),g.add(m),J.onpaint=he=>{const pe=he.changedElements;for(const te of g)pe.includes(te.image)&&(te.needsUpdate=!0)},J.requestPaint();return}if(i.texElementImage2D.length===3)i.texElementImage2D(i.TEXTURE_2D,i.RGBA8,$);else{const pe=i.RGBA,te=i.RGBA,Pe=i.UNSIGNED_BYTE;i.texElementImage2D(i.TEXTURE_2D,0,pe,te,Pe,$)}i.texParameteri(i.TEXTURE_2D,i.TEXTURE_MIN_FILTER,i.LINEAR),i.texParameteri(i.TEXTURE_2D,i.TEXTURE_WRAP_S,i.CLAMP_TO_EDGE),i.texParameteri(i.TEXTURE_2D,i.TEXTURE_WRAP_T,i.CLAMP_TO_EDGE)}}else if(Ce.length>0){if(Ue&&Fe){const J=We(Ce[0]);t.texStorage2D(i.TEXTURE_2D,ue,le,J.width,J.height)}for(let J=0,he=Ce.length;J<he;J++)ce=Ce[J],Ue?P&&t.texSubImage2D(i.TEXTURE_2D,J,0,0,re,Te,ce):t.texImage2D(i.TEXTURE_2D,J,le,re,Te,ce);m.generateMipmaps=!1}else if(Ue){if(Fe){const J=We($);t.texStorage2D(i.TEXTURE_2D,ue,le,J.width,J.height)}P&&t.texSubImage2D(i.TEXTURE_2D,0,0,0,re,Te,$)}else t.texImage2D(i.TEXTURE_2D,0,le,re,Te,$);d(m)&&A(G),de.__version=oe.version,m.onUpdate&&m.onUpdate(m)}y.__version=m.version}function Me(y,m,I){if(m.image.length!==6)return;const G=k(y,m),W=m.source;t.bindTexture(i.TEXTURE_CUBE_MAP,y.__webglTexture,i.TEXTURE0+I);const oe=n.get(W);if(W.version!==oe.__version||G===!0){t.activeTexture(i.TEXTURE0+I);const de=Xe.getPrimaries(Xe.workingColorSpace),X=m.colorSpace===Dn?null:Xe.getPrimaries(m.colorSpace),$=m.colorSpace===Dn||de===X?i.NONE:i.BROWSER_DEFAULT_WEBGL;t.pixelStorei(i.UNPACK_FLIP_Y_WEBGL,m.flipY),t.pixelStorei(i.UNPACK_PREMULTIPLY_ALPHA_WEBGL,m.premultiplyAlpha),t.pixelStorei(i.UNPACK_ALIGNMENT,m.unpackAlignment),t.pixelStorei(i.UNPACK_COLORSPACE_CONVERSION_WEBGL,$);const re=m.isCompressedTexture||m.image[0].isCompressedTexture,Te=m.image[0]&&m.image[0].isDataTexture,le=[];for(let te=0;te<6;te++)!re&&!Te?le[te]=p(m.image[te],!0,r.maxCubemapSize):le[te]=Te?m.image[te].image:m.image[te],le[te]=ft(m,le[te]);const ce=le[0],Ce=s.convert(m.format,m.colorSpace),Ue=s.convert(m.type),Fe=M(m.internalFormat,Ce,Ue,m.normalized,m.colorSpace),P=m.isVideoTexture!==!0,ue=oe.__version===void 0||G===!0,J=W.dataReady;let he=E(m,ce);ge(i.TEXTURE_CUBE_MAP,m);let pe;if(re){P&&ue&&t.texStorage2D(i.TEXTURE_CUBE_MAP,he,Fe,ce.width,ce.height);for(let te=0;te<6;te++){pe=le[te].mipmaps;for(let Pe=0;Pe<pe.length;Pe++){const Ae=pe[Pe];m.format!==It?Ce!==null?P?J&&t.compressedTexSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+te,Pe,0,0,Ae.width,Ae.height,Ce,Ae.data):t.compressedTexImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+te,Pe,Fe,Ae.width,Ae.height,0,Ae.data):Ie("WebGLRenderer: Attempt to load unsupported compressed texture format in .setTextureCube()"):P?J&&t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+te,Pe,0,0,Ae.width,Ae.height,Ce,Ue,Ae.data):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+te,Pe,Fe,Ae.width,Ae.height,0,Ce,Ue,Ae.data)}}}else{if(pe=m.mipmaps,P&&ue){pe.length>0&&he++;const te=We(le[0]);t.texStorage2D(i.TEXTURE_CUBE_MAP,he,Fe,te.width,te.height)}for(let te=0;te<6;te++)if(Te){P?J&&t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+te,0,0,0,le[te].width,le[te].height,Ce,Ue,le[te].data):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+te,0,Fe,le[te].width,le[te].height,0,Ce,Ue,le[te].data);for(let Pe=0;Pe<pe.length;Pe++){const ut=pe[Pe].image[te].image;P?J&&t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+te,Pe+1,0,0,ut.width,ut.height,Ce,Ue,ut.data):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+te,Pe+1,Fe,ut.width,ut.height,0,Ce,Ue,ut.data)}}else{P?J&&t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+te,0,0,0,Ce,Ue,le[te]):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+te,0,Fe,Ce,Ue,le[te]);for(let Pe=0;Pe<pe.length;Pe++){const Ae=pe[Pe];P?J&&t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+te,Pe+1,0,0,Ce,Ue,Ae.image[te]):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+te,Pe+1,Fe,Ce,Ue,Ae.image[te])}}}d(m)&&A(i.TEXTURE_CUBE_MAP),oe.__version=W.version,m.onUpdate&&m.onUpdate(m)}y.__version=m.version}function Se(y,m,I,G,W,oe){const de=s.convert(I.format,I.colorSpace),X=s.convert(I.type),$=M(I.internalFormat,de,X,I.normalized,I.colorSpace),re=n.get(m),Te=n.get(I);if(Te.__renderTarget=m,!re.__hasExternalTextures){const le=Math.max(1,m.width>>oe),ce=Math.max(1,m.height>>oe);W===i.TEXTURE_3D||W===i.TEXTURE_2D_ARRAY?t.texImage3D(W,oe,$,le,ce,m.depth,0,de,X,null):t.texImage2D(W,oe,$,le,ce,0,de,X,null)}t.bindFramebuffer(i.FRAMEBUFFER,y),at(m)?o.framebufferTexture2DMultisampleEXT(i.FRAMEBUFFER,G,W,Te.__webglTexture,0,Je(m)):(W===i.TEXTURE_2D||W>=i.TEXTURE_CUBE_MAP_POSITIVE_X&&W<=i.TEXTURE_CUBE_MAP_NEGATIVE_Z)&&i.framebufferTexture2D(i.FRAMEBUFFER,G,W,Te.__webglTexture,oe),t.bindFramebuffer(i.FRAMEBUFFER,null)}function ke(y,m,I){if(i.bindRenderbuffer(i.RENDERBUFFER,y),m.depthBuffer){const G=m.depthTexture,W=G&&G.isDepthTexture?G.type:null,oe=w(m.stencilBuffer,W),de=m.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT;at(m)?o.renderbufferStorageMultisampleEXT(i.RENDERBUFFER,Je(m),oe,m.width,m.height):I?i.renderbufferStorageMultisample(i.RENDERBUFFER,Je(m),oe,m.width,m.height):i.renderbufferStorage(i.RENDERBUFFER,oe,m.width,m.height),i.framebufferRenderbuffer(i.FRAMEBUFFER,de,i.RENDERBUFFER,y)}else{const G=m.textures;for(let W=0;W<G.length;W++){const oe=G[W],de=s.convert(oe.format,oe.colorSpace),X=s.convert(oe.type),$=M(oe.internalFormat,de,X,oe.normalized,oe.colorSpace);at(m)?o.renderbufferStorageMultisampleEXT(i.RENDERBUFFER,Je(m),$,m.width,m.height):I?i.renderbufferStorageMultisample(i.RENDERBUFFER,Je(m),$,m.width,m.height):i.renderbufferStorage(i.RENDERBUFFER,$,m.width,m.height)}}i.bindRenderbuffer(i.RENDERBUFFER,null)}function Re(y,m,I){const G=m.isWebGLCubeRenderTarget===!0;if(t.bindFramebuffer(i.FRAMEBUFFER,y),!(m.depthTexture&&m.depthTexture.isDepthTexture))throw new Error("THREE.WebGLTextures: renderTarget.depthTexture must be an instance of THREE.DepthTexture.");const W=n.get(m.depthTexture);if(W.__renderTarget=m,(!W.__webglTexture||m.depthTexture.image.width!==m.width||m.depthTexture.image.height!==m.height)&&(m.depthTexture.image.width=m.width,m.depthTexture.image.height=m.height,m.depthTexture.needsUpdate=!0),G){if(W.__webglInit===void 0&&(W.__webglInit=!0,m.depthTexture.addEventListener("dispose",R)),W.__webglTexture===void 0){W.__webglTexture=i.createTexture(),t.bindTexture(i.TEXTURE_CUBE_MAP,W.__webglTexture),ge(i.TEXTURE_CUBE_MAP,m.depthTexture);const re=s.convert(m.depthTexture.format),Te=s.convert(m.depthTexture.type);let le;m.depthTexture.format===Sn?le=i.DEPTH_COMPONENT24:m.depthTexture.format===Wn&&(le=i.DEPTH24_STENCIL8);for(let ce=0;ce<6;ce++)i.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+ce,0,le,m.width,m.height,0,re,Te,null)}}else Y(m.depthTexture,0);const oe=W.__webglTexture,de=Je(m),X=G?i.TEXTURE_CUBE_MAP_POSITIVE_X+I:i.TEXTURE_2D,$=m.depthTexture.format===Wn?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT;if(m.depthTexture.format===Sn)at(m)?o.framebufferTexture2DMultisampleEXT(i.FRAMEBUFFER,$,X,oe,0,de):i.framebufferTexture2D(i.FRAMEBUFFER,$,X,oe,0);else if(m.depthTexture.format===Wn)at(m)?o.framebufferTexture2DMultisampleEXT(i.FRAMEBUFFER,$,X,oe,0,de):i.framebufferTexture2D(i.FRAMEBUFFER,$,X,oe,0);else throw new Error("THREE.WebGLTextures: Unknown depthTexture format.")}function Ne(y){const m=n.get(y),I=y.isWebGLCubeRenderTarget===!0;if(m.__boundDepthTexture!==y.depthTexture){const G=y.depthTexture;if(m.__depthDisposeCallback&&m.__depthDisposeCallback(),G){const W=()=>{delete m.__boundDepthTexture,delete m.__depthDisposeCallback,G.removeEventListener("dispose",W)};G.addEventListener("dispose",W),m.__depthDisposeCallback=W}m.__boundDepthTexture=G}if(y.depthTexture&&!m.__autoAllocateDepthBuffer)if(I)for(let G=0;G<6;G++)Re(m.__webglFramebuffer[G],y,G);else{const G=y.texture.mipmaps;G&&G.length>0?Re(m.__webglFramebuffer[0],y,0):Re(m.__webglFramebuffer,y,0)}else if(I){m.__webglDepthbuffer=[];for(let G=0;G<6;G++)if(t.bindFramebuffer(i.FRAMEBUFFER,m.__webglFramebuffer[G]),m.__webglDepthbuffer[G]===void 0)m.__webglDepthbuffer[G]=i.createRenderbuffer(),ke(m.__webglDepthbuffer[G],y,!1);else{const W=y.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT,oe=m.__webglDepthbuffer[G];i.bindRenderbuffer(i.RENDERBUFFER,oe),i.framebufferRenderbuffer(i.FRAMEBUFFER,W,i.RENDERBUFFER,oe)}}else{const G=y.texture.mipmaps;if(G&&G.length>0?t.bindFramebuffer(i.FRAMEBUFFER,m.__webglFramebuffer[0]):t.bindFramebuffer(i.FRAMEBUFFER,m.__webglFramebuffer),m.__webglDepthbuffer===void 0)m.__webglDepthbuffer=i.createRenderbuffer(),ke(m.__webglDepthbuffer,y,!1);else{const W=y.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT,oe=m.__webglDepthbuffer;i.bindRenderbuffer(i.RENDERBUFFER,oe),i.framebufferRenderbuffer(i.FRAMEBUFFER,W,i.RENDERBUFFER,oe)}}t.bindFramebuffer(i.FRAMEBUFFER,null)}function Be(y,m,I){const G=n.get(y);m!==void 0&&Se(G.__webglFramebuffer,y,y.texture,i.COLOR_ATTACHMENT0,i.TEXTURE_2D,0),I!==void 0&&Ne(y)}function Ge(y){const m=y.texture,I=n.get(y),G=n.get(m);y.addEventListener("dispose",v);const W=y.textures,oe=y.isWebGLCubeRenderTarget===!0,de=W.length>1;if(de||(G.__webglTexture===void 0&&(G.__webglTexture=i.createTexture()),G.__version=m.version,a.memory.textures++),oe){I.__webglFramebuffer=[];for(let X=0;X<6;X++)if(m.mipmaps&&m.mipmaps.length>0){I.__webglFramebuffer[X]=[];for(let $=0;$<m.mipmaps.length;$++)I.__webglFramebuffer[X][$]=i.createFramebuffer()}else I.__webglFramebuffer[X]=i.createFramebuffer()}else{if(m.mipmaps&&m.mipmaps.length>0){I.__webglFramebuffer=[];for(let X=0;X<m.mipmaps.length;X++)I.__webglFramebuffer[X]=i.createFramebuffer()}else I.__webglFramebuffer=i.createFramebuffer();if(de)for(let X=0,$=W.length;X<$;X++){const re=n.get(W[X]);re.__webglTexture===void 0&&(re.__webglTexture=i.createTexture(),a.memory.textures++)}if(y.samples>0&&at(y)===!1){I.__webglMultisampledFramebuffer=i.createFramebuffer(),I.__webglColorRenderbuffer=[],t.bindFramebuffer(i.FRAMEBUFFER,I.__webglMultisampledFramebuffer);for(let X=0;X<W.length;X++){const $=W[X];I.__webglColorRenderbuffer[X]=i.createRenderbuffer(),i.bindRenderbuffer(i.RENDERBUFFER,I.__webglColorRenderbuffer[X]);const re=s.convert($.format,$.colorSpace),Te=s.convert($.type),le=M($.internalFormat,re,Te,$.normalized,$.colorSpace,y.isXRRenderTarget===!0),ce=Je(y);i.renderbufferStorageMultisample(i.RENDERBUFFER,ce,le,y.width,y.height),i.framebufferRenderbuffer(i.FRAMEBUFFER,i.COLOR_ATTACHMENT0+X,i.RENDERBUFFER,I.__webglColorRenderbuffer[X])}i.bindRenderbuffer(i.RENDERBUFFER,null),y.depthBuffer&&(I.__webglDepthRenderbuffer=i.createRenderbuffer(),ke(I.__webglDepthRenderbuffer,y,!0)),t.bindFramebuffer(i.FRAMEBUFFER,null)}}if(oe){t.bindTexture(i.TEXTURE_CUBE_MAP,G.__webglTexture),ge(i.TEXTURE_CUBE_MAP,m);for(let X=0;X<6;X++)if(m.mipmaps&&m.mipmaps.length>0)for(let $=0;$<m.mipmaps.length;$++)Se(I.__webglFramebuffer[X][$],y,m,i.COLOR_ATTACHMENT0,i.TEXTURE_CUBE_MAP_POSITIVE_X+X,$);else Se(I.__webglFramebuffer[X],y,m,i.COLOR_ATTACHMENT0,i.TEXTURE_CUBE_MAP_POSITIVE_X+X,0);d(m)&&A(i.TEXTURE_CUBE_MAP),t.unbindTexture()}else if(de){for(let X=0,$=W.length;X<$;X++){const re=W[X],Te=n.get(re);let le=i.TEXTURE_2D;(y.isWebGL3DRenderTarget||y.isWebGLArrayRenderTarget)&&(le=y.isWebGL3DRenderTarget?i.TEXTURE_3D:i.TEXTURE_2D_ARRAY),t.bindTexture(le,Te.__webglTexture),ge(le,re),Se(I.__webglFramebuffer,y,re,i.COLOR_ATTACHMENT0+X,le,0),d(re)&&A(le)}t.unbindTexture()}else{let X=i.TEXTURE_2D;if((y.isWebGL3DRenderTarget||y.isWebGLArrayRenderTarget)&&(X=y.isWebGL3DRenderTarget?i.TEXTURE_3D:i.TEXTURE_2D_ARRAY),t.bindTexture(X,G.__webglTexture),ge(X,m),m.mipmaps&&m.mipmaps.length>0)for(let $=0;$<m.mipmaps.length;$++)Se(I.__webglFramebuffer[$],y,m,i.COLOR_ATTACHMENT0,X,$);else Se(I.__webglFramebuffer,y,m,i.COLOR_ATTACHMENT0,X,0);d(m)&&A(X),t.unbindTexture()}y.depthBuffer&&Ne(y)}function $e(y){const m=y.textures;for(let I=0,G=m.length;I<G;I++){const W=m[I];if(d(W)){const oe=b(y),de=n.get(W).__webglTexture;t.bindTexture(oe,de),A(oe),t.unbindTexture()}}}const it=[],lt=[];function ct(y){if(y.samples>0){if(at(y)===!1){const m=y.textures,I=y.width,G=y.height;let W=i.COLOR_BUFFER_BIT;const oe=y.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT,de=n.get(y),X=m.length>1;if(X)for(let re=0;re<m.length;re++)t.bindFramebuffer(i.FRAMEBUFFER,de.__webglMultisampledFramebuffer),i.framebufferRenderbuffer(i.FRAMEBUFFER,i.COLOR_ATTACHMENT0+re,i.RENDERBUFFER,null),t.bindFramebuffer(i.FRAMEBUFFER,de.__webglFramebuffer),i.framebufferTexture2D(i.DRAW_FRAMEBUFFER,i.COLOR_ATTACHMENT0+re,i.TEXTURE_2D,null,0);t.bindFramebuffer(i.READ_FRAMEBUFFER,de.__webglMultisampledFramebuffer);const $=y.texture.mipmaps;$&&$.length>0?t.bindFramebuffer(i.DRAW_FRAMEBUFFER,de.__webglFramebuffer[0]):t.bindFramebuffer(i.DRAW_FRAMEBUFFER,de.__webglFramebuffer);for(let re=0;re<m.length;re++){if(y.resolveDepthBuffer&&(y.depthBuffer&&(W|=i.DEPTH_BUFFER_BIT),y.stencilBuffer&&y.resolveStencilBuffer&&(W|=i.STENCIL_BUFFER_BIT)),X){i.framebufferRenderbuffer(i.READ_FRAMEBUFFER,i.COLOR_ATTACHMENT0,i.RENDERBUFFER,de.__webglColorRenderbuffer[re]);const Te=n.get(m[re]).__webglTexture;i.framebufferTexture2D(i.DRAW_FRAMEBUFFER,i.COLOR_ATTACHMENT0,i.TEXTURE_2D,Te,0)}i.blitFramebuffer(0,0,I,G,0,0,I,G,W,i.NEAREST),c===!0&&(it.length=0,lt.length=0,it.push(i.COLOR_ATTACHMENT0+re),y.depthBuffer&&y.resolveDepthBuffer===!1&&(it.push(oe),lt.push(oe),i.invalidateFramebuffer(i.DRAW_FRAMEBUFFER,lt)),i.invalidateFramebuffer(i.READ_FRAMEBUFFER,it))}if(t.bindFramebuffer(i.READ_FRAMEBUFFER,null),t.bindFramebuffer(i.DRAW_FRAMEBUFFER,null),X)for(let re=0;re<m.length;re++){t.bindFramebuffer(i.FRAMEBUFFER,de.__webglMultisampledFramebuffer),i.framebufferRenderbuffer(i.FRAMEBUFFER,i.COLOR_ATTACHMENT0+re,i.RENDERBUFFER,de.__webglColorRenderbuffer[re]);const Te=n.get(m[re]).__webglTexture;t.bindFramebuffer(i.FRAMEBUFFER,de.__webglFramebuffer),i.framebufferTexture2D(i.DRAW_FRAMEBUFFER,i.COLOR_ATTACHMENT0+re,i.TEXTURE_2D,Te,0)}t.bindFramebuffer(i.DRAW_FRAMEBUFFER,de.__webglMultisampledFramebuffer)}else if(y.depthBuffer&&y.resolveDepthBuffer===!1&&c){const m=y.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT;i.invalidateFramebuffer(i.DRAW_FRAMEBUFFER,[m])}}}function Je(y){return Math.min(r.maxSamples,y.samples)}function at(y){const m=n.get(y);return y.samples>0&&e.has("WEBGL_multisampled_render_to_texture")===!0&&m.__useRenderToTexture!==!1}function L(y){const m=a.render.frame;h.get(y)!==m&&(h.set(y,m),y.update())}function ft(y,m){const I=y.colorSpace,G=y.format,W=y.type;return y.isCompressedTexture===!0||y.isVideoTexture===!0||I!==wr&&I!==Dn&&(Xe.getTransfer(I)===je?(G!==It||W!==Bt)&&Ie("WebGLTextures: sRGB encoded textures have to use RGBAFormat and UnsignedByteType."):Ke("WebGLTextures: Unsupported texture color space:",I)),m}function We(y){return typeof HTMLImageElement<"u"&&y instanceof HTMLImageElement?(l.width=y.naturalWidth||y.width,l.height=y.naturalHeight||y.height):typeof VideoFrame<"u"&&y instanceof VideoFrame?(l.width=y.displayWidth,l.height=y.displayHeight):(l.width=y.width,l.height=y.height),l}this.allocateTextureUnit=q,this.resetTextureUnits=Z,this.getTextureUnits=K,this.setTextureUnits=F,this.setTexture2D=Y,this.setTexture2DArray=ee,this.setTexture3D=ae,this.setTextureCube=se,this.rebindTextures=Be,this.setupRenderTarget=Ge,this.updateRenderTargetMipmap=$e,this.updateMultisampleRenderTarget=ct,this.setupDepthRenderbuffer=Ne,this.setupFrameBufferTexture=Se,this.useMultisampledRTT=at,this.isReversedDepthBuffer=function(){return t.buffers.depth.getReversed()}}function Kp(i,e){function t(n,r=Dn){let s;const a=Xe.getTransfer(r);if(n===Bt)return i.UNSIGNED_BYTE;if(n===fa)return i.UNSIGNED_SHORT_4_4_4_4;if(n===ha)return i.UNSIGNED_SHORT_5_5_5_1;if(n===il)return i.UNSIGNED_INT_5_9_9_9_REV;if(n===rl)return i.UNSIGNED_INT_10F_11F_11F_REV;if(n===tl)return i.BYTE;if(n===nl)return i.SHORT;if(n===Ii)return i.UNSIGNED_SHORT;if(n===da)return i.INT;if(n===cn)return i.UNSIGNED_INT;if(n===zt)return i.FLOAT;if(n===Mn)return i.HALF_FLOAT;if(n===sl)return i.ALPHA;if(n===al)return i.RGB;if(n===It)return i.RGBA;if(n===Sn)return i.DEPTH_COMPONENT;if(n===Wn)return i.DEPTH_STENCIL;if(n===ol)return i.RED;if(n===pa)return i.RED_INTEGER;if(n===qn)return i.RG;if(n===ma)return i.RG_INTEGER;if(n===ga)return i.RGBA_INTEGER;if(n===vr||n===xr||n===Mr||n===Sr)if(a===je)if(s=e.get("WEBGL_compressed_texture_s3tc_srgb"),s!==null){if(n===vr)return s.COMPRESSED_SRGB_S3TC_DXT1_EXT;if(n===xr)return s.COMPRESSED_SRGB_ALPHA_S3TC_DXT1_EXT;if(n===Mr)return s.COMPRESSED_SRGB_ALPHA_S3TC_DXT3_EXT;if(n===Sr)return s.COMPRESSED_SRGB_ALPHA_S3TC_DXT5_EXT}else return null;else if(s=e.get("WEBGL_compressed_texture_s3tc"),s!==null){if(n===vr)return s.COMPRESSED_RGB_S3TC_DXT1_EXT;if(n===xr)return s.COMPRESSED_RGBA_S3TC_DXT1_EXT;if(n===Mr)return s.COMPRESSED_RGBA_S3TC_DXT3_EXT;if(n===Sr)return s.COMPRESSED_RGBA_S3TC_DXT5_EXT}else return null;if(n===Ps||n===Ls||n===Ds||n===Us)if(s=e.get("WEBGL_compressed_texture_pvrtc"),s!==null){if(n===Ps)return s.COMPRESSED_RGB_PVRTC_4BPPV1_IMG;if(n===Ls)return s.COMPRESSED_RGB_PVRTC_2BPPV1_IMG;if(n===Ds)return s.COMPRESSED_RGBA_PVRTC_4BPPV1_IMG;if(n===Us)return s.COMPRESSED_RGBA_PVRTC_2BPPV1_IMG}else return null;if(n===Is||n===Ns||n===Fs||n===Os||n===Bs||n===Tr||n===zs)if(s=e.get("WEBGL_compressed_texture_etc"),s!==null){if(n===Is||n===Ns)return a===je?s.COMPRESSED_SRGB8_ETC2:s.COMPRESSED_RGB8_ETC2;if(n===Fs)return a===je?s.COMPRESSED_SRGB8_ALPHA8_ETC2_EAC:s.COMPRESSED_RGBA8_ETC2_EAC;if(n===Os)return s.COMPRESSED_R11_EAC;if(n===Bs)return s.COMPRESSED_SIGNED_R11_EAC;if(n===Tr)return s.COMPRESSED_RG11_EAC;if(n===zs)return s.COMPRESSED_SIGNED_RG11_EAC}else return null;if(n===Gs||n===Vs||n===Hs||n===ks||n===Ws||n===Xs||n===qs||n===Ys||n===Ks||n===Zs||n===$s||n===Js||n===Qs||n===js)if(s=e.get("WEBGL_compressed_texture_astc"),s!==null){if(n===Gs)return a===je?s.COMPRESSED_SRGB8_ALPHA8_ASTC_4x4_KHR:s.COMPRESSED_RGBA_ASTC_4x4_KHR;if(n===Vs)return a===je?s.COMPRESSED_SRGB8_ALPHA8_ASTC_5x4_KHR:s.COMPRESSED_RGBA_ASTC_5x4_KHR;if(n===Hs)return a===je?s.COMPRESSED_SRGB8_ALPHA8_ASTC_5x5_KHR:s.COMPRESSED_RGBA_ASTC_5x5_KHR;if(n===ks)return a===je?s.COMPRESSED_SRGB8_ALPHA8_ASTC_6x5_KHR:s.COMPRESSED_RGBA_ASTC_6x5_KHR;if(n===Ws)return a===je?s.COMPRESSED_SRGB8_ALPHA8_ASTC_6x6_KHR:s.COMPRESSED_RGBA_ASTC_6x6_KHR;if(n===Xs)return a===je?s.COMPRESSED_SRGB8_ALPHA8_ASTC_8x5_KHR:s.COMPRESSED_RGBA_ASTC_8x5_KHR;if(n===qs)return a===je?s.COMPRESSED_SRGB8_ALPHA8_ASTC_8x6_KHR:s.COMPRESSED_RGBA_ASTC_8x6_KHR;if(n===Ys)return a===je?s.COMPRESSED_SRGB8_ALPHA8_ASTC_8x8_KHR:s.COMPRESSED_RGBA_ASTC_8x8_KHR;if(n===Ks)return a===je?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x5_KHR:s.COMPRESSED_RGBA_ASTC_10x5_KHR;if(n===Zs)return a===je?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x6_KHR:s.COMPRESSED_RGBA_ASTC_10x6_KHR;if(n===$s)return a===je?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x8_KHR:s.COMPRESSED_RGBA_ASTC_10x8_KHR;if(n===Js)return a===je?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x10_KHR:s.COMPRESSED_RGBA_ASTC_10x10_KHR;if(n===Qs)return a===je?s.COMPRESSED_SRGB8_ALPHA8_ASTC_12x10_KHR:s.COMPRESSED_RGBA_ASTC_12x10_KHR;if(n===js)return a===je?s.COMPRESSED_SRGB8_ALPHA8_ASTC_12x12_KHR:s.COMPRESSED_RGBA_ASTC_12x12_KHR}else return null;if(n===ea||n===ta||n===na)if(s=e.get("EXT_texture_compression_bptc"),s!==null){if(n===ea)return a===je?s.COMPRESSED_SRGB_ALPHA_BPTC_UNORM_EXT:s.COMPRESSED_RGBA_BPTC_UNORM_EXT;if(n===ta)return s.COMPRESSED_RGB_BPTC_SIGNED_FLOAT_EXT;if(n===na)return s.COMPRESSED_RGB_BPTC_UNSIGNED_FLOAT_EXT}else return null;if(n===ia||n===ra||n===Ar||n===sa)if(s=e.get("EXT_texture_compression_rgtc"),s!==null){if(n===ia)return s.COMPRESSED_RED_RGTC1_EXT;if(n===ra)return s.COMPRESSED_SIGNED_RED_RGTC1_EXT;if(n===Ar)return s.COMPRESSED_RED_GREEN_RGTC2_EXT;if(n===sa)return s.COMPRESSED_SIGNED_RED_GREEN_RGTC2_EXT}else return null;return n===Ni?i.UNSIGNED_INT_24_8:i[n]!==void 0?i[n]:null}return{convert:t}}const Zp=`
void main() {
