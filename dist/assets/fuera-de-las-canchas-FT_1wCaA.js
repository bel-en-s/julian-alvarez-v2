import{g as s,S as N}from"./menu-Cz7_jPK3.js";/* empty css             *//* empty css                              *//* empty css                     */import{O as pe,W as he,a as L,F as W,R as U,L as F,S as I,V as ge,b as V,c as C,P as ye,M as H}from"./three.module-BcibPuIU.js";import{S as P}from"./SplitText-Cpc1cBKW.js";s.registerPlugin(N,P);document.addEventListener("DOMContentLoaded",()=>{document.body.style.backgroundColor="#1E2024";try{J()}catch(e){console.warn("initFdcAtmos error:",e)}try{K()}catch(e){console.warn("initFdcShader error:",e)}const S=document.querySelector(".fdc");if(!S)return;G(),O(),X(),Y();function G(){const e=document.querySelector(".fdc-hero-inner h1");if(e){const t=new P(e,{type:"chars",charsClass:"hero-char"});s.fromTo(t.chars,{y:-400,opacity:0,visibility:"visible"},{y:0,opacity:1,duration:.7,stagger:.035,ease:"power4.out",delay:.3,onComplete:()=>s.set(t.chars,{clearProps:"transform"})})}const o=S.querySelectorAll(".fdc-hero-inner > [data-copy-wrapper]");o.length&&(s.set(o,{y:40,opacity:0}),s.to(o,{y:0,opacity:1,duration:1,stagger:.15,ease:"power4.out",delay:.3}))}function O(){document.querySelectorAll("[data-marquee]").forEach(t=>{const r=parseFloat(t.dataset.marquee),n=t.cloneNode(!0);t.parentElement.appendChild(n),s.to([t,n],{xPercent:r===1?-50:50,duration:30,repeat:-1,ease:"none"})}),s.utils.toArray(".band").forEach((t,r)=>{s.to(t,{x:r%2===0?80:-80,ease:"none",scrollTrigger:{trigger:".press-section",start:"top bottom",end:"bottom top",scrub:!0}})})}function X(){const e=document.querySelector(".partidos"),o=S.querySelectorAll("[data-copy-wrapper]"),t=e?e.querySelectorAll("[data-copy-wrapper]"):[];[...o,...t].forEach(n=>{const i=window.innerWidth<1e3;s.context(()=>{const a=Array.from(n.children),l=[];if(a.forEach(p=>{try{const h=P.create(p,{type:"lines",linesClass:"line",lineThreshold:.1});l.push(...h.lines)}catch{}}),!l.length)return;s.set(l,{y:"100%"});const v=s.to(l,{y:"0%",duration:i?.5:1,stagger:i?.05:.1,ease:"power4.out",overwrite:"auto",paused:!0});N.create({trigger:n,start:"top 80%",animation:v,once:!0,refreshPriority:-1})},n)})}function Y(){const e=document.querySelectorAll("[data-parallax]");!e.length||window.innerWidth<640||e.forEach(o=>{const t=parseFloat(o.dataset.parallax)||40;o.querySelector("img")&&s.fromTo(o,{y:-t},{y:t,ease:"none",scrollTrigger:{trigger:o,start:"top bottom",end:"bottom top",scrub:1}})})}const D=`
    varying vec2 vUv;
    void main() {
      vUv = uv;
