    ...
    <div ref={containerRef}>
        ...
        <div className="project-preview-wrapper">
          <div className="preview-col">
            <div className="preview-img">
              <img loading="lazy" src="/spotlight/spotlight_img_03.webp" alt="" />
            </div>
            <div className="preview-img">
              <img loading="lazy" src="/spotlight/spotlight_img_06.webp" alt="" />
            </div>
            <div className="preview-img">
              <img loading="lazy" src="/spotlight/spotlight_img_09.webp" alt="" />
            </div>
          </div>
          <div className="preview-col">
            <div className="preview-img">
              <img loading="lazy" src="/spotlight/spotlight_img_01.webp" alt="" />
            </div>
            <div className="preview-img">
              <img loading="lazy" src="/spotlight/spotlight_img_04.webp" alt="" />
            </div>
            <div className="preview-img">
              <img loading="lazy" src="/spotlight/spotlight_img_07.webp" alt="" />
            </div>
          </div>
          <div className="preview-col main-preview-col">
            <div className="preview-img">
              <img loading="lazy" src="/spotlight/spotlight_img_02.webp" alt="" />
            </div>
            <div className="preview-img main-preview-img">
              <img loading="lazy" src="/spotlight/spotlight_img_05.webp" alt="" />
            </div>
            <div className="preview-img">
              <img loading="lazy" src="/spotlight/spotlight_img_08.webp" alt="" />
            </div>
          </div>
          <div className="preview-col">
            <div className="preview-img">
      ...
      <section className="genesis-hero">
        <div className="gen-hero-img">
          <img src="/genesis/hero.webp" loading="lazy" alt="" />
        </div>
