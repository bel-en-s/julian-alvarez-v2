      ...
      <section className="product-hero" ref={heroRef}>
        <div className="product-hero-col product-snapshots">
          <div className="product-snapshot">
            <img src={bp + "/product/product_shot_01.jpg"} alt="" />
          </div>
          <div className="product-snapshot">
            <img src={bp + "/product/product_shot_02.jpg"} alt="" />
          </div>
          <div className="product-snapshot">
            <img src={bp + "/product/product_shot_03.jpg"} alt="" />
          </div>
          <div className="product-snapshot">
            <img src={bp + "/product/product_shot_04.jpg"} alt="" />
          </div>
          <div className="product-snapshot">
            <img src={bp + "/product/product_shot_05.jpg"} alt="" />
          </div>
          <div className="product-snapshot-minimap">
            <div className="product-snapshot-minimap-img">
              <img src={bp + "/product/product_minimap_01.jpg"} alt="" />
            </div>
            <div className="product-snapshot-minimap-img">
              <img src={bp + "/product/product_minimap_02.jpg"} alt="" />
            </div>
            <div className="product-snapshot-minimap-img">
              <img src={bp + "/product/product_minimap_03.jpg"} alt="" />
            </div>
            <div className="product-snapshot-minimap-img">
              <img src={bp + "/product/product_minimap_04.jpg"} alt="" />
            </div>
            <div className="product-snapshot-minimap-img">
              <img src={bp + "/product/product_minimap_05.jpg"} alt="" />
            </div>
          </div>
        </div>
